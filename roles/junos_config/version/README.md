...
With all of that out of the way, let's talk about the variables available for the `version` template.
...
|---|---|---|---|---|
| configuration.version | no | n/a | n/a | dictionary that hosts all access-related items |
| configuration.version.address_assignment | no | n/a | n/a | dictionary that hosts all DHCP related items |
| configuration.version.address_assignment.pool | no | n/a | n/a | dictionary that hosts all DHCP pool items |
| configuration.version.address_assignment.pool | no | n/a | n/a | dictionary that hosts all DHCP pool items |
